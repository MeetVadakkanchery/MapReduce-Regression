...
hadoop jar conversionData.jar Conversion /user/mrv281/Project_Data/Event_Data_Apr.txt /user/mrv281/output
hadoop fs -get output
hdfs dfs -rm -r output
cat output/part-r-00000
mv output/part-r-00000 output/Conversion_Data_Apr.txt
